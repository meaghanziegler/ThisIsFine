...
namespace ThisIsFine.WebAPI
{
    ...
    /// Swagger normally won't find it - the /token endpoint - due to it being programmatically genreated.
    /// </summary>
                ...
                .EnableSwagger(c =>
                    {
                        ...
                        //
                        c.SingleApiVersion("v1", "ThisIsFine.WebAPI");
                        ...
                        //Show the programmatically genterated /token endpoint in the UI.
